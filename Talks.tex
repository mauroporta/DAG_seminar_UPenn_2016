...
\input{ch1_infty_categories}
\input{ch2_derived_affines}
\input{ch3_stable}
\input{ch4_cotangent_complex}
\input{ch5_square_zero}
\input{ch6_perfect_complexes}
\input{ch7_descent}
\input{ch8_stacks}
\input{ch9_stack_perf}
\input{ch10_dmod}
\input{ch11_dmod_derham}
\input{ch12_symplectic}
\input{ch13_gw}
